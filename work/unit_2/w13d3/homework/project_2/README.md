...
## Attendance
Attendance is mandatory for Tuesday and Wednesday of next week! You will presenting your project on Saturday!
...
* Must be all original work: [Review GA's Plagiarism Policy](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-MAE/wiki/Student-Handbook)

### &#x1F535; Stretch Goals (Not Mandatory):
#### Recommended Features

* Add additional relationships (models can be related in a one-to-many relationship, for example)
  - [Optional notes on having two models](FIRST_MODEL.md)
  - [Optional notes on relating two models](SECOND_MODEL.md)
...
**Saturday, May 2, 2020 - Mandatory**<br>
...
Your project is due on Saturday, May 9th at 7 AM EST. You will present your project and show your code to classmates and instructors.
...
Some of these examples have authentication. This has been moved to a later lesson in SEIR so please disregard for project 2 :)
